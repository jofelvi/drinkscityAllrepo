...
export default class RrppListaEventos extends React.Component{
        ...
        if(datos.store.id == store.id){
          return(
              <Card key={i} style={{ width: "99%", borderColor: "#01DAC9", borderWidth: 1, backgroundColor: "#111111" }} >
                <CardItem button onPress={() => this.props.navigation.navigate('Invitados',{titulo: 'Listado de eventos publicados', side: 'Home', event_id: data.data.id}) } style={{backgroundColor: "#111111"}}>
                  <Left />
                  <Body />
                  <Right />
                </CardItem>
                <CardItem cardBody button onPress={() => this.props.navigation.navigate('Invitados',{titulo: 'Listado de eventos publicados', side: 'Home', event_id: data.data.id}) } style={{backgroundColor: "#111111"}}>
                  <Image 
